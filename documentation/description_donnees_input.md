...
|------------------------------|-------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| rev_i_agricoles              | i1; i2; g15 ; g18 ; g21 ; g24 | revenu de l'activite principale si l'individu est agriculteur independant + des revenus résiduels, individualises, provenant de la vente de produits agricoles et d elevage                                                           |
...
| rev_i_independants_Ntaxe     | i1;i2                         | revenu de l'activitee principale si l'individu est independant, non agricole, et NE paie PAS des impots                                                                                                                               |
...
| rev_i_salaires_informels     | i1; i2; i3 ; i11              | revenu de l'activitee principale si l'individu ne tombe dans aucune des autres categories + revenus de l activite secondaire + autres revenus non encore cites                                                                        |
