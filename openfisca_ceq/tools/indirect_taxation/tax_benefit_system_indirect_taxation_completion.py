...
def add_coicop_item_to_tax_benefit_system(tax_benefit_system, country):
    ...
    label_by_code_coicop = (
        build_label_by_code_coicop(country, filter_expression=filter_expression)
    ...
    tax_rate_by_code_coicop = build_tax_rate_by_code_coicop(
        country, tax_variables, fillna=fillna, filter_expression=filter_expression
    )
    tax_name = "tva"
    null_rates = ["exonere"]
    generate_depenses_ht_postes_variables(
    ...
    generate_tariff_base_variables(
        tax_benefit_system, "droits_douane", tax_rate_by_code_coicop, null_rates
    )
    generate_ad_valorem_tax_variables(
        tax_benefit_system, tax_name, tax_rate_by_code_coicop, null_rates
    )
