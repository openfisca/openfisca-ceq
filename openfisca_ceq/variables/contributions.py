...
class other_contributions(Variable):
    ...
    def formula(household, period):
        ...
        self_employed_other_contributions = household(
            "self_employed_other_contributions", period
        )
...
class contributions_health(Variable):
    ...
    def formula(household, period):
        employee_contributions_health = household(
            "employee_contributions_health", period
        )
        employer_contributions_health = household(
            "employer_contributions_health", period
        )
        self_employed_contributions_health = household(
            "self_employed_contributions_health", period
        )
...
class contributions_pensions(Variable):
    ...
    def formula(household, period):
        employee_contributions_pensions = household(
            "employee_contributions_pensions", period
        )
        employer_contributions_pensions = household(
            "employer_contributions_pensions", period
        )
        self_employed_contributions_pensions = household(
            "self_employed_contributions_pensions", period
        )
